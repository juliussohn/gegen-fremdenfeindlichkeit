...
app.controller('appCtrl', function ($scope, $rootScope, WizardHandler, $window) {
    ...
    $scope.questions = [    {    
        ...
            result: 3300,
            unit: " EUR",
            question: "Wie viel verdient Deutschland jährlich an jedem in Deutschland wohnenden Ausländer durch Steuern?",
            color: "#13DFA4",
        ...
            result: 243,
            unit: " Mio EUR",
            question: "Wie viel Geld des Bundeshaushaltes wurde 2015 für das Bundesamt für Migration und Flüchtlinge ausgegeben?",
        color: "#eb6f63",
        ...
            result: 143,
            unit: " EUR",
            question: "Wie viel Geld erhält ein Asylbewerber monatlich in einer Erstaufnahme-Einrichtung?",
        color: "#f39c11",
