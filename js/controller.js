...
app.controller('appCtrl', function ($scope, $rootScope, WizardHandler, $window) {
    ...
    $scope.questions = [    {    
        ...
            result: 3300,
            unit: " EUR",
            question: "Wie viel verdient Deutschland jährlich an jedem in Deutschland wohnendem Ausländer durch Steuern?",
            color: "#13DFA4",
        ...
            result: 143,
            unit: " EUR",
            question: "Wie viel Geld bekommt ein Asylbewerber monatlich in einer Erstaufnahme-Einrichtung?",
        color: "#f39c11",
